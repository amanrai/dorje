...
@tool(description="Chunk a Markdown/plaintext handle or collection into paragraph-aligned chunk handles/collection.", requires="derivative:text/markdown|text/plain", produces="collection/full_text_chunk")
def chunk_md_handle(
    handle: str,
    max_chars: int = DEFAULT_MAX_CHARS,
    overlap_paragraphs: int = DEFAULT_OVERLAP_PARAGRAPHS,
